...
<body style="background-color:#f2f9fd;">
	...
	<div class="leftnav">
		...
		<ul style="display:block">
			<li><a
					href="${pageContext.request.contextPath}/order.action?method=queryByPage"
			...
			<li><a
					href="${pageContext.request.contextPath}/catelog.action?method=getAll"
