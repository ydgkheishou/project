...
<div class="leftnav">
    ...
    <ul style="display:block">
        <li><a
                href="${pageContext.request.contextPath}/admin.action?method=queryByPage"
                target="right"><span class="icon-caret-right"></span>账户管理</a></li>
        <li><a
                href="${pageContext.request.contextPath}/admin.action?method=toAddInfomation"
                target="right"><span class="icon-caret-right"></span>发布公告</a></li>

        <li><a
                href="${pageContext.request.contextPath}/admin.action?method=toAddCourse"
                target="right"><span class="icon-caret-right"></span>课程注册</a></li>
        <li><a
                href="${pageContext.request.contextPath}/admin.action?method=queryGradeByPage"
...
<ul class="bread">
    <li><a <%--href="{:U('Index/info')}"--%>  href="${pageContext.request.contextPath}/toInfo.action"  target="right" class="icon-home">
        首页</a></li>
...
<div class="admin">
    <iframe scrolling="auto" frameborder="0"
            src="${pageContext.request.contextPath}/toInfo.action" name="right"
